...
#define _LANGUAGE_EN_H_
    ...
    #define STRING_MOVE_IDEX              "Move Idex"
    #define STRING_HOME                   "Home"
    #define STRING_X_HOME_IDEX_X1           "Home X1"
    #define STRING_X_HOME_IDEX_X2           "Home X2"
    ...
    #define STRING_X_INC_IDEX_X1          "X1+"
    #define STRING_X_INC_IDEX_X2          "X2+"
    #define STRING_Y_INC                  "Y+"
    #define STRING_Z_INC                  "Z+"
    #define STRING_X_DEC                  "X-"
    #define STRING_X_DEC_IDEX_X1          "X1-"
    #define STRING_X_DEC_IDEX_X2          "X2-"
